...
class Tracker():
    def __init__(self):
        ...
        self.video_file = dir + videofile_name + ".avi"
...
# def fit_ellipse_on_contour():
#     global ellipse, contour_list
#     if contour_list is None or len(contour_list) == 0:
#         ellipse = None
...
#
# def run_Tracker():
#     global frame_counter, contour_list
#
...
#         save_number_of_contours(number_contours_per_frame)
#
...
#         save_number_of_contours(number_relevant_contours_per_frame)
#
#         # check if fish started
#         if not fish_started:
#             check_if_fish_started(roi)
#
...
def save_number_of_contours(number_cnt_list):
    global contour_list
